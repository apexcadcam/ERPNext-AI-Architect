...
| [`docs/runtime/`](docs/runtime/) | [Runtime Architecture](docs/runtime/RUNTIME_ARCHITECTURE.md) — the domain-agnostic "operating system" (module system, plugin registry, pipeline engine, event bus, DI, storage abstraction, CLI) every module, including the Crawler, plugs into. Architecture only; not implemented. |
